package net.roguelogix.biggerreactors.client.old.reactor;
...
public class GuiReactorActivityToggle<T extends Container> extends GuiPartBase<T> implements IHasTooltip {
    ...
    public boolean mouseClicked(double mouseX, double mouseY, int button) {
        if (!this.isMouseOver(mouseX, mouseY)) {
            ...
            ((ReactorTerminalContainer) this.screen.getContainer()).executeRequest("setActive", reactorActivity != ReactorActivity.ACTIVE);
