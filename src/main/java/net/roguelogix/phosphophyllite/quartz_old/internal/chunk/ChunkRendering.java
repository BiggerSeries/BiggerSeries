    ...
    public static void startup() {
        ...
        switch (OperationMode.mode()) {
            case GL45: {
                ...
                // set uniform 1 to the model-view-projection matrix (there is a buffer for that in Renderer)
                // then draw with
                ...
                // UV coordinates are 0,0 is top left of texture up or facing north looking at face for T/B
                // faceID is used for TBO lookups
                // see RenderChunk for more info on how that's used
...
//        Minecraft.getInstance().world.
        ...
        
        {
            ...
            // this fucker yeets GL_TEXTURE2 from me, *soooo* that's nice...
...
//        iprofiler.endStartSection("occlusionTest");
        ...
        glUniformMatrix4fv(1, false, modelViewProjectionMatrixBuffer);
        playerOffset.set(0, 0, 0); // chunkPos
        playerOffset.sub(playerPosition);
...
//        glDrawElements(GL_TRIANGLE_STRIP, 14, GL_UNSIGNED_INT, 0);
    ...
    private static void queryLayer(int layer) {
        ...
        cullQueryProgram.bind();
        playerOffset.set(0, layer * 16, 0).sub(playerPosition);
        glUniform3f(0, (float) playerOffset.x % 1, (float) playerOffset.y, (float) playerOffset.z % 1);
