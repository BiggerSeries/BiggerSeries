...
public class ControlRodScreen extends GuiScreenBase<ControlRodContainer> implements IHasContainer<ControlRodContainer> {
    ...
    public void render(int mouseX, int mouseY, float partialTicks) {
        ...
        // Draw buttons.
        this.rodInsert.drawTooltip(mouseX, mouseY);
        this.rodRetract.drawTooltip(mouseX, mouseY);

        // Draw rod bars.
        this.barInsertionLevel.drawTooltip(mouseX, mouseY);

        // Draw rod bar symbols.
        this.symbolInsertionLevel.drawTooltip(mouseX, mouseY);

        // Check for updatable elements.
        this.rodInsert.doClick(mouseX, mouseY, GLFW_MOUSE_BUTTON_1);
        this.rodRetract.doClick(mouseX, mouseY, GLFW_MOUSE_BUTTON_1);
    }
    ...
    public void drawGuiContainerForegroundLayer(int mouseX, int mouseY) {
        this.font.drawString(new TranslationTextComponent("screen.biggerreactors.reactor_control_rod").getString(), 8, 6, 4210752);

        // Draw button.
        this.rodInsert.drawPart();
        this.rodRetract.drawPart();

        // Draw rod bars.
        this.barInsertionLevel.drawPart();

        // Draw rod bar symbols.
        this.symbolInsertionLevel.drawPart();
    }
}
